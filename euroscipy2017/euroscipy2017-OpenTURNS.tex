...
\title[OpenTURNS]{The OpenTURNS uncertainty quantification Python module}
...
\date[]{August 2017, EuroSciPy 2017, Erlangen, Allemagne}
...
* Internal components : Base, Uncertainty

* Packaging : Debian, Conda
