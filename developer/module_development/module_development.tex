...
\begin{frame}
  \frametitle{No existing template}
  \begin{block}{}
...
\begin{frame}
  \frametitle{Steps}
  \begin{block}{Development and maintenance}     
    \begin{itemize}
      \item For development and maintenance, similar to the previous case (C++)
      \item For docstrings, examples it is more simple!
      \item For the setup, use \texttt{setuptools} 
      \item For the tests, use \texttt{openturns test} or \texttt{pytest} 
    \end{itemize}
  \end{block}
\end{frame}
