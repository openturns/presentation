...
#  Id:      $Id: ac_pkg_swig.m4 862 2008-06-26 11:50:17Z dutka $
#
...
AC_DEFUN([AC_PROG_SWIG],[
        ...
        if test -z "$SWIG" ; then
                ...
                SWIG='echo "Error: SWIG not found. Check configuration" ; false'
        elif test -n "$1" ; then
                ...
                if test -n "$swig_version" ; then
                        ...
                        if test $available_major -ne $required_major \
                                ...
                                SWIG='echo "Error: SWIG version >= $1 is required.  You have '"$swig_version"'.  You should look at http://www.swig.org or check configuration" ; false'
                        else
                        ...
                        SWIG='echo "Error: Cannot determine SWIG version.  You should look at http://www.swig.org or check configuration" ; false'
                fi
        fi
        AC_SUBST([SWIG_LIB])
        ac_prog_swig_res="ok"
